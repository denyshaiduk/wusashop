...
const PRODUCTS = [
  ...
  { name: 'Ніж у шкіряному чохлі «Мисливець»', category: 'Ножі', description: 'Великий ніж із декоративним литтям у чорному шкіряному чохлі. Готовий подарунковий варіант для колекціонера або поціновувача ручної роботи.', price: 2400, craftTime: 'від 7 днів', isHit: false, images: [slice(47, 47)[0], slice(48, 48)[0]] },
